...
copter = dead.copter.copter.DeadCopter(disturbance_level=1e-3,
                                       mass=2, arm_length=0.225, K_v=1000,
                                       voltage_max=18, voltage_min=15, prop_diameter_in=10)

# simulator intialisation
sim = dead.copter.simulator.Simulator(t_simulation=3, t_sampling=1/125, measurement_noise_multiplier=1e-4)
