...
copter = dead.copter.copter.DeadCopter(disturbance_level=1e-10,
                                       mass=1.5, arm_length=0.225, K_v=1000,
                                       voltage_max=17, voltage_min=15, prop_diameter_in=9)

# simulator intialisation
sim = dead.copter.simulator.Simulator(t_simulation=3, t_sampling=0.01, measurement_noise_multiplier=1e-4)
