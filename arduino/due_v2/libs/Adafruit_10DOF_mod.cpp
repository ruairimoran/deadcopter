...
bool Adafruit_10DOF_Kalman_Filter::update(sensors_event_t *accel_event,sensors_event_t *gyro_event,sensors_vec_t *orientation){
    ...
    #ifdef MOULI_ADD_YAW  
    Predicted_yaw +=( ( (gyro_event->gyro.z-gyro_cal[2]) *180/ PI) - Velocity_yaw ) *dt;
    #endif
    ...
    #ifdef MOULI_ADD_YAW    
    PZ00+=dt*(dt*PZ11-PZ01-PZ10+Q_angle);
    PZ01-=dt*PZ11;
    PZ10-=dt*PZ11;
    PZ11+=Q_velocity*dt;
    #endif
    ...
    #ifdef MOULI_ADD_YAW
    Predicted_yaw += (0 - Predicted_yaw) * KZ0;
    Velocity_yaw +=(0 - Predicted_yaw) * KZ1;
    #endif
    ...
    #ifdef MOULI_ADD_YAW
    orientation->heading=Predicted_yaw;
    #endif
